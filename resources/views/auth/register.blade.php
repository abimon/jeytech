            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="instagram" class="col-md-4 col-form-label text-md-end">{{ __('Instagram Link') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="twitter" class="col-md-4 col-form-label text-md-end">{{ __('Twitter/X Link') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="linkedin" class="col-md-4 col-form-label text-md-end">{{ __('LinkedIn Link') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="avatar" class="col-md-4 col-form-label text-md-end">{{ __('Passport Size Photo') }}</label>

                            <div class="col-md-6">
                                <input id="avatar" type="file" accept="image/*" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" required autocomplete="avatar">
