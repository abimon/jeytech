    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header p-1 d-flex justify-content-between mb-3">
                <h6 class="p-2">All Projects</h6>
                <a href="{{route('portfolio.create')}}" class="btn btn-outline-primary"><i class="bi bi-plus"></i> Projects</a>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{route('portfolio.edit', $update->id)}}" class="text-secondary font-weight-bold text-xs text-warning" data-toggle="tooltip" data-original-title="Edit">
                                        Edit
                                    </a>
                                </td>
                                <td class="align-middle">
                                    ...
                                    <div class="modal fade" id="delete{{$update->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('portfolio.destroy', $update->id)}}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <div class="modal-body text-danger">
                                                    Do you want to delete this Project?<br>
                                                    </div>
