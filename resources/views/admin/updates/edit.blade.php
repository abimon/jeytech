...
@section('content')
<form method="POST" action="{{route('updates.update', $update->id) }}" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="container">
        <div class="form-floating mb-2">
            <input type="text" value="{{$update->title}}" name="title" placeholder=" " class="form-control">
        ...
        <div class="form-group mb-2">
            <textarea class="form-control" id="editor0" name="details">{{$update->details}}</textarea>
            <span id="count"></span>
            @error('content')
            <div class="text-danger">{{$message}}</div>
            @enderror
        ...
        <div class="form-floating mb-2">
            <input type="text" name="summary" value="{{$update->summary}}" oninput="wordsCount()" placeholder=" " id='mess' class="form-control">
        ...
        <div class="form-floating mb-2">
            ...
            <img id="output" src="{{asset('storage/updates/'.$update->cover)}}" height="100" />
            <div class="pt-2">
